...
class TugasController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        foreach ($records as $record) {
            ...
            $modify = '
                <td class="text-end">
                    <div class="actions">
                        <a href="'.url('guru/tugas/view/'.$record->id).'" class="btn btn-sm bg-success-light me-2">
                            <i class="fe fe-eye"></i>
                        </a>
                        <a href="'.url('guru/tugas/edit/'.$record->id).'" class="btn btn-sm bg-danger-light">
    ...
    public function nilai($id, $nisn)
    {
        ...
        return view('guru.tugas-view-edit', [
            'title'=> 'Edit Nilai',
            'id'=> $id,
            'nilai'=> $nilais,
            'nisn'=> $nisn,
    ...
    public function nilai_store(Request $request, $nisn)
    {
        ...
        try {
            ...
            return redirect()->route('guru/tugas/view', ['id' => $request->id]);
        } catch (\Exception $th) {
            DB::rollback();
