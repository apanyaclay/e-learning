...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="main-wrapper">
                    ...
                    <li class="nav-item dropdown has-arrow new-user-menus">
                        <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                            <span class="user-img">
                                ...
                                {{ Storage::url('foto-admin/'.Auth::user()->admin->foto) }}" width="31"alt="{{ Auth::user()->username }}
                                @elseif (Auth::user()->role == 'pengajar')
                                {{ Storage::url('foto-pengajar/'.Auth::user()->pengajar->foto) }}" width="31"alt="{{ Auth::user()->username }}
                                @else
                                {{ Storage::url('foto-siswa/'.Auth::user()->siswa->foto) }}" width="31"alt="{{ Auth::user()->username }}
                                @endif">
                                <div class="user-text">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="@if (Auth::user()->role=='pengajar')
                                {{route('admin/profile')}}
                            @elseif (Auth::user()->role=='pengajar')
            ...
            @yield('content')
            <footer>
                <p>Copyright ©  <?php echo date('Y'); ?> {{config('app.name')}}.</p>
            </footer>
