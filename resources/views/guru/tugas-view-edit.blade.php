                        ...
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('guru/tugas/view/edit', ['id' => $id, 'nisn' => $nisn]) }}">Kuis</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('guru/tugas/view/edit_store', ['nisn'=> $nisn]) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Komentar <span class="login-danger">*</span></label>
