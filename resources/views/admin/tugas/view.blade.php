                                                                ...
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $value->nisn }}</td>
                                                                            <td>{{ $value->nama }}</td>
                                                                            <td>@if ($jawaban->get($value->nisn))
                                                                                <a href="{{Storage::url('tugas/'.$jawaban->get($value->nisn)->jawaban)}}" download="" target="_blank" class="btn
                                                                            ...
                                                                            <td class="text-end">
                                                                                <div class="actions">
                                                                                    @if ($jawaban->get($value->nisn))
                                                                                        <a href="{{url('admin/tugas/view/'.$id.'/edit/'.$value->nisn)}}" class="btn btn-sm bg-danger-light">
