                        ...
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin/tugas/edit', ['id' => $tugas->id]) }}">Kuis</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('admin/tugas/edit_update') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4" hidden>
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('id') is-invalid @enderror"
                                                name="id" placeholder="masukkan ID" value="{{ $tugas->id }}">
                                            @error('id')
                                        ...
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('pertemuan_id') is-invalid @enderror"
                                                ...
                                                @foreach ($pertemuan as $value)
                                                    <option
                                                        value="{{ $value->id }}"{{ $tugas->pertemuan_id == $value->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('detail') is-invalid @enderror" name="detail" id="editor">{{ $tugas->detail }}</textarea>
                                            @error('detail')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
