                                            ...
                                            <div class="page-header">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                                        <a href="{{ route('admin/soal/add', ['id' => $id]) }}" class="btn btn-primary">
                                                                            ...
                                                                            <td class="text-end">
                                                                                <div class="actions">
                                                                                    @if ($nilai->get($value->nisn))
                                                                                        <a href="{{url('admin/kuis/view/'.$id.'/hasil/'.$value->nisn)}}" class="btn btn-sm bg-danger-light">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <form action="{{ route('admin/soal/delete', ['id' => $id]) }}" method="POST">
                                @csrf
