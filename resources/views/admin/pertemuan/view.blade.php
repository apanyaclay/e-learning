...
@section('content')
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="postingan">
                                    <div class="post-wrapper">
                                        <div class="post">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6"><a
                                                        href="{{ Storage::url('ebook/' . $materi->ebook->file) }}"
                                                        download="" target="_blank"class="btn
                                        ...
                                        <div class="post-form">
                                            <form action="{{ route('admin/pertemuan/view_store') }}" method="POST">
                                                @csrf
    ...
    <script>
        $(document).ready(function() {
            function fetchPosts() {
                $.ajax({
                    url: '{{ route('admin/pertemuan/fetchPosts', $pertemuan->id) }}',
                    method: 'GET',
