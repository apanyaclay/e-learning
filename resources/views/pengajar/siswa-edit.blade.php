                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pengajar/siswa/edit', ['nisn' => $student->nisn]) }}">Siswa</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('pengajar/siswa/edit_form') }}" method="POST"
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select
                                                ...
                                                <option value="P" {{ $student->jenis_kelamin == 'P' ? 'selected' : 'P' }}>
                                                    Perempuan</option>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('agama') is-invalid @enderror"
                                                ...
                                                <option value="Hindu" {{ $student->agama == 'Hindu' ? 'selected' : '' }}>Hindu
                                                </option>
                                                <option value="Kristen" {{ $student->agama == 'Kristen' ? 'selected' : '' }}>
                                                    Kristen</option>
                                                <option value="Katolik" {{ $student->agama == 'Katolik' ? 'selected' : '' }}>
                                                    Katolik</option>
                                                <option value="Islam" {{ $student->agama == 'Islam' ? 'selected' : '' }}>Islam
                                                </option>
                                                <option value="Budha" {{ $student->agama == 'Budha' ? 'selected' : '' }}>Budha
                                                </option>
                                            </select>
                                            @error('agama')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <select class="form-control select @error('kelas_id') is-invalid @enderror"
                                                ...
                                                @foreach ($kelass as $kelas)
                                                    <option value="{{ $kelas->id }}"
                                                        {{ $student->kelas_id == $kelas->id ? 'selected' : '' }}>
                                                        {{ $kelas->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('kelas_id')
                                            ...
                                            <select class="form-control select @error('jurusan_id') is-invalid @enderror"
                                                ...
                                                @foreach ($jurusans as $jurusan)
                                                    <option value="{{ $jurusan->id }}"
                                                        {{ $student->jurusan_id == $jurusan->id ? 'selected' : '' }}>
                                                        {{ $jurusan->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('jurusan_id')
                                            ...
                                            <div class="uplod">
                                                <h2 class="table-avatar">
                                                    <a class="avatar avatar-sm me-2">
                                                        <img class="avatar-img rounded-circle" src="{{ Storage::url('foto-siswa/'.$student->foto) }}" alt="User Image">
                                                    </a>
                                                </h2>
                                                <label
