...
class MataPelajaransTableSeeder extends Seeder
{
    ...
    private function getMataPelajaranData()
    {
        return [
            ...
            ['nama' => 'Pendidikan Agama Islam', 'kkm'=> '70'],
            ['nama' => 'Pendidikan Agama Kristen', 'kkm'=> '70'],
            ['nama' => 'Pendidikan Agama Katolik', 'kkm'=> '70'],
            ['nama' => 'Pendidikan Agama Hindu', 'kkm'=> '70'],
            ['nama' => 'Pendidikan Agama Budha', 'kkm'=> '70'],
